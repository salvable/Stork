...
app.get('/stork/:storkName/:userId',authMiddleware.checkAuth, storkController.getStork)
app.get('/storks/:userId',authMiddleware.checkAuth, storkController.getStorks)
